...
public class GamePadInfo
{
    ...
    /// <summary>
    /// Creates a new GamePafInfo for the gamepad connected at the specified player index.
    /// </summary>
    ...
    #region Methods
    /// <summary>
    /// Updates the state information for this gamepad info.
    /// </summary>
    ...
    /// <summary>
    /// Returns a value that indicates if the specified gamepad button is currently down.
    /// </summary>
    ...
    /// <summary>
    /// Returns a value that indicates if the specified gamepad button is currently up.
    /// </summary>
    /// <param name="button">The gamepad button to check.</param>
    ...
    /// <summary>
    /// Returns a value that indicates if the specified gamepad button whas just pressed on the current frame.
    /// </summary>
    /// <param name="button">The gamepad button to check.</param>
    ...
    /// <summary>
    /// Returns a value that indicates if the specified gamepad button whas just released on the current frame.
    /// </summary>
    /// <param name="button">The gamepad button to check.</param>
    ...
    /// </summary>
    /// <param name"strenght">The strenght of the vibration from 0.0f (none) to 1.0f (full).</param>
    /// <param name"time">The amount of time the vibration should occur..</param>
    public void SetVibration(float strenght, TimeSpan time)
    {
        _vibrationTimeRemaining = time;
        GamePad.SetVibration(PlayerIndex, strenght, strenght);
    }
