...
public class Tileset
{
    ...
    /// <summary>
    /// Gets the width, in pixel, of each tile in this tileset.
    /// </summary>
    public int TileWidth { get; }

    /// <summary>
    /// Gets the height, in pixel, of each tile in this tileset.
    /// </summary>
    ...
    public Tileset(TextureRegion textureRegion, int tileWidth, int tileHeight)
    {
        ...
        // Create the texture region that makes up each individual tile
